...
nmap("<leader>m", function() harpoon:list():add() end)
nmap("<leader>'", function() harpoon.ui:toggle_quick_menu(harpoon:list()) end)
nmap("<leader>;", function() harpoon:list():next() end)
nmap("<leader>:", function() harpoon:list():prev() end)
nmap("<leader>1", function() harpoon:list():select(1) end)
nmap("<leader>2", function() harpoon:list():select(1) end)
nmap("<leader>3", function() harpoon:list():select(1) end)
nmap("<leader>4", function() harpoon:list():select(1) end)
nmap("<leader>5", function() harpoon:list():select(1) end)
...
nmap("<leader>cc", '<cmd>CodeiumToggle<CR>')
imap('<C-y>', function () return vim.fn['codeium#Accept']() end, { expr = true, silent = true })
imap("<c-n>", select_next)
imap("<c-p>", select_prev)
imap("<c-x>", cancel)
